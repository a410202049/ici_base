...
class Pager {
    ...
    */
    ...
    public $last_page='末页';//尾页
     ...
     function next_page($style='pg_next')
     {
         ...
         return '<li class="'.$style.'">'.$this->next_page.'</li>';
     }
    ...
    {
        if($this->nowindex == 1){
            return '<li class="'.$style.'">'.$this->first_page.'</li>';
        }
    ...
    */
    ...
    {
        if($this->nowindex == $this->totalpage){
            return '<li class="'.$style.'">'.$this->last_page.'</li>';
        }
    ...
    function nowbar($style='pg_link',$nowindex_style='pg_curr')
    {
        ...
        for($i = $begin;$i <= $end; $i++)
        {
            if($i != $this->nowindex){
                ...
                $out.= '<li class="active"><a class="'.$nowindex_style.'">'.$i.'</a></li>';
            }
    ...
    function show($mode=1)
    {
        switch ($mode)
        {
            ...
            case 3://上一页 1 2 3 4 5 下一页
                ...
                break;
            case 4://上一页 1 2 3 4 5 下一页 第x页
                return '<div class="pagination"><ul class="pager">'.$this->pre_page('pjax').$this->nowbar('pjax').$this->next_page('pjax').'</ul></div>';
                break;
...
/*----------------private function (私有方法)-----------------------------------------------------------*/
    ...
    */
    function _get_url($pagenum=1)
    {
        ...
        $urlStr = preg_replace("/[\?|&][\d]{13}=/", "", $urlStr);
